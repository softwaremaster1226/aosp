...
import com.kr.messaging.datamodel.action.HandleLowStorageAction;
import com.kr.messaging.sms.SmsReleaseStorage;
import com.kr.messaging.sms.SmsReleaseStorage.Duration;
import com.kr.messaging.sms.SmsStorageStatusManager;
...
public class SmsStorageLowWarningFragment extends Fragment {
    ...
    private static class ChooseActionDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(final Bundle savedInstanceState) {
            ...
            // For test
            AlertDialogHelper.adjustAlertDialog((AlertDialog) dialog, getContext().getDrawable(R.drawable.round_gray));
    ...
    private static class ConfirmationDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(final Bundle savedInstanceState) {
            ...
            // zeus
            AlertDialogHelper.adjustAlertDialog(dialog, getContext().getDrawable(R.drawable.round_gray));
            return dialog;
        }
