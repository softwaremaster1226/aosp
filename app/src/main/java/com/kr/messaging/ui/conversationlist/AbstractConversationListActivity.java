 ...
 */
package com.kr.messaging.ui.conversationlist;
...
import com.kr.messaging.datamodel.action.DeleteConversationAction;
import com.kr.messaging.datamodel.action.UpdateConversationArchiveStatusAction;
import com.kr.messaging.datamodel.action.UpdateConversationOptionsAction;
import com.kr.messaging.datamodel.action.UpdateDestinationBlockedAction;
...
import com.kr.messaging.ui.SnackBarInteraction;
import com.kr.messaging.ui.UIIntents;
import com.kr.messaging.ui.contact.AddContactsConfirmationDialog;
import com.kr.messaging.ui.conversationlist.ConversationListFragment.ConversationListFragmentHost;
import com.kr.messaging.ui.conversationlist.MultiSelectActionModeCallback.SelectedConversation;
...
import com.kr.messaging.util.Trace;
...
public abstract class AbstractConversationListActivity  extends BugleActionBarActivity
    ...
    public void onActionBarDelete(final Collection<SelectedConversation> conversations) {
        ...
        AlertDialog dialog = new AlertDialog.Builder(this)
                ...
                .create();
        AlertDialogHelper.adjustAlertDialog(dialog, getDrawable(R.drawable.round_gray));
        dialog.show();
    }
