...
import com.kr.messaging.datamodel.action.ProcessDeliveryReportAction;
import com.kr.messaging.datamodel.action.ProcessDownloadedMmsAction;
import com.kr.messaging.datamodel.action.ProcessSentMessageAction;
import com.kr.messaging.datamodel.data.ParticipantData;
import com.kr.messaging.sms.MmsUtils;
import com.kr.messaging.sms.SmsSender;
...
public class SendStatusReceiver extends BroadcastReceiver {
    public static final String MESSAGE_SENT_ACTION =
            "com.kr.messaging.receiver.SendStatusReceiver.MESSAGE_SENT";
    public static final String MESSAGE_DELIVERED_ACTION =
            "com.kr.messaging.receiver.SendStatusReceiver.MESSAGE_DELIVERED";
    public static final String MMS_SENT_ACTION =
            "com.kr.messaging.receiver.SendStatusReceiver.MMS_SENT";
    public static final String MMS_DOWNLOADED_ACTION =
            "com.kr.messaging.receiver.SendStatusReceiver.MMS_DOWNLOADED";
