...
import com.kr.messaging.receiver.SmsReceiver;
import com.kr.messaging.sms.ApnDatabase;
import com.kr.messaging.sms.BugleApnSettingsLoader;
import com.kr.messaging.sms.BugleUserAgentInfoLoader;
...
public class BugleApplication extends Application implements UncaughtExceptionHandler {
    ...
    private void maybeStartProfiling() {
        ...
        //  adb pull /data/data/com.kr.messaging/cache/startup.trace /tmp
