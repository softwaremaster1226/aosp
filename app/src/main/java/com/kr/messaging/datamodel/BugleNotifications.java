...
import com.kr.messaging.datamodel.MessageNotificationState.BundledMessageNotificationState;
import com.kr.messaging.datamodel.MessageNotificationState.ConversationLineInfo;
import com.kr.messaging.datamodel.MessageNotificationState.MultiConversationNotificationState;
import com.kr.messaging.datamodel.MessageNotificationState.MultiMessageNotificationState;
import com.kr.messaging.datamodel.action.MarkAsReadAction;
import com.kr.messaging.datamodel.action.MarkAsSeenAction;
import com.kr.messaging.datamodel.action.RedownloadMmsAction;
import com.kr.messaging.datamodel.data.ConversationListItemData;
import com.kr.messaging.datamodel.media.AvatarRequestDescriptor;
import com.kr.messaging.datamodel.media.ImageResource;
import com.kr.messaging.datamodel.media.MediaRequest;
import com.kr.messaging.datamodel.media.MediaResourceManager;
import com.kr.messaging.datamodel.media.MessagePartVideoThumbnailRequestDescriptor;
import com.kr.messaging.datamodel.media.UriImageRequestDescriptor;
import com.kr.messaging.datamodel.media.VideoThumbnailRequest;
import com.kr.messaging.sms.MmsSmsUtils;
import com.kr.messaging.sms.MmsUtils;
import com.kr.messaging.ui.UIIntents;
import com.kr.messaging.util.Assert;
import com.kr.messaging.util.AvatarUriUtil;
import com.kr.messaging.util.BugleGservices;
import com.kr.messaging.util.BugleGservicesKeys;
import com.kr.messaging.util.BuglePrefs;
import com.kr.messaging.util.BuglePrefsKeys;
import com.kr.messaging.util.ContentType;
import com.kr.messaging.util.ConversationIdSet;
import com.kr.messaging.util.ImageUtils;
import com.kr.messaging.util.LogUtil;
import com.kr.messaging.util.NotificationPlayer;
import com.kr.messaging.util.OsUtil;
import com.kr.messaging.util.PendingIntentConstants;
import com.kr.messaging.util.PhoneUtils;
import com.kr.messaging.util.RingtoneUtil;
import com.kr.messaging.util.ThreadUtil;
import com.kr.messaging.util.UriUtil;
